...
`SKATER_WEIGHTS` at `src/fantasyPoints.py:5-15`):
...
`moneypuckGamePoints` (`src/fantasyPoints.py:44-86`) is the single skater
...
documented ~5% approximation, accepted (`src/fantasyPoints.py:1-4`,
