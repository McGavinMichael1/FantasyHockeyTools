...
class FakeLeague:
    ...
    def __init__(self, picks, details):
        self._picks = picks
...
def test_get_draft_results_joins_names_onto_picks():
    league = FakeLeague(
        picks=[_pick(1, 1, '465.l.33072.t.4', 6743),
               _pick(2, 1, '465.l.33072.t.9', 5980)],
    ...
    assert rows == [
        {'pick': 1, 'round': 1, 'team_key': '465.l.33072.t.4',
         'yahoo_player_id': 6743, 'player_name': 'Connor McDavid'},
        {'pick': 2, 'round': 1, 'team_key': '465.l.33072.t.9',
         'yahoo_player_id': 5980, 'player_name': 'Nathan MacKinnon'},
    ]
...
def test_get_draft_results_resolves_names_in_one_batched_call():
    ...
    league = FakeLeague(
        picks=[_pick(i, 1, '465.l.33072.t.1', 1000 + i) for i in range(1, 31)],
...
def test_get_draft_results_keeps_picks_whose_name_yahoo_cannot_resolve():
    ...
    league = FakeLeague(
        picks=[_pick(1, 1, '465.l.33072.t.4', 6743), _pick(2, 1, '465.l.33072.t.9', 999)],
